...
export class ParseBash {
  ...
  */
        ...
        let versionLine: string = "# bash-models version ";
            ...
            for (let line of lines) {
                ...
                if (!foundDescription) {
                    ...
                    if (!line.startsWith("Usage: $0")) {
                        scriptModel.description = line.trim();
                    }
        ...
        scriptModel.BuiltInParameters.Logging = this.logDirectorySupported(sections[2], scriptModel.parameters);
        if (scriptModel.BuiltInParameters.Logging !== undefined) {
            scriptModel.BuiltInParameters.Logging.type = ParameterType.Logging;
        }
        scriptModel.BuiltInParameters.InputFile = this.inputFileSupported(sections[0], scriptModel.parameters);
        if (scriptModel.BuiltInParameters.InputFile !== undefined) {
            scriptModel.BuiltInParameters.InputFile.type = ParameterType.InputFile;
        }
        scriptModel.BuiltInParameters.Verbose = this.verboseSupported(sections[0], scriptModel.parameters);
        if (scriptModel.BuiltInParameters.Verbose !== undefined) {
            scriptModel.BuiltInParameters.Verbose.type = ParameterType.Verbose;
        }
