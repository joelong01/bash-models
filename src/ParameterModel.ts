...
import { ParameterType, IParameterState } from "./commonModel"
...
export class ParameterModel {
    ...
    private propertyChangedEvent = new EventDispatcher<ParameterModel, keyof IParameterState>();
    private modelUpdate: boolean = false; // an update that is initiated inside the model


    public get onPropertyChanged(): IEvent<ParameterModel, keyof IParameterState> {
        return this.propertyChangedEvent.asEvent();
    }
    public signal(changedProperty: keyof IParameterState) {
    ...
    public NotifyPropertyChanged(property: keyof IParameterState): void {
    ...
    set default(value: string) {
        if (value !== this.Default) {
            ...
            if (this.Type === ParameterType.Logging) {
